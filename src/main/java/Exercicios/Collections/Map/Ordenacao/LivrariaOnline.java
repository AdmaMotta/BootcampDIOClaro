...
public class LivrariaOnline {
    ...
    public void removerLivro (String titulo) {
        List<String> removerChaves = new ArrayList<>();
        for (Map.Entry<String, Livro> entry : livros.entrySet()) {
            if (entry.getValue().getTitulo().equalsIgnoreCase(titulo)) {
                removerChaves.add(entry.getKey());
            }
        }
        for (String chave : removerChaves) {
            livros.remove(chave);
        }
    }

    public Map<String, Livro> exibirLivrosOrdemPreco () {
    ...
    public Map<String, Livro> pesquisarPorAutor (String autor) {
        ...
        for (Map.Entry<String, Livro> entry : livros.entrySet()) {
            ...
            if(livro.getAutor().equalsIgnoreCase(autor)) {
                livrosAutor.put(entry.getKey(), livro);
            }
        }
        return livrosAutor;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(livrariaOnline.exibirLivrosOrdemPreco());
